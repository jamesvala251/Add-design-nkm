...
class DeviceVideoViewScreen extends StatefulWidget {
  const DeviceVideoViewScreen({Key? key}) : super(key: key);

  @override
  State<DeviceVideoViewScreen> createState() => _DeviceVideoViewScreenState();
}

class _DeviceVideoViewScreenState extends State<DeviceVideoViewScreen> {
  ...
  void initState() {
    ...
    videoPath = argument[RouteConstants.videoPath];
