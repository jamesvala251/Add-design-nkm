...
class UpdateSupplierSelectionBottomSheetWidget extends StatelessWidget {
            ...
            : _commonController.errorStringSupplier.value.isNotEmpty
                ? SomethingWentWrongWidget(
                    ...
                    retryOnSomethingWentWrong: () =>
                        _commonController.errorStringSupplier.value,
                  )
                : Column(
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (_, index) => ListTile(
                            onTap: () {
                              _updateDesignController.selectedSupplierId =
                                  _commonController.supplierList[index].id;
                              supplierController.text =
                                  _commonController.supplierList[index].name;
                              Get.back();
                            },
                            trailing: _updateDesignController.selectedSupplierId ==
                                    _commonController.supplierList[index].id
                                ? Icon(
                                    Icons.check_circle,
                                    color: Get.theme.primaryColor,
