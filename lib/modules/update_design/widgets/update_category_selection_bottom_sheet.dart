...
class UpdateCategorySelectionBottomSheetWidget extends StatelessWidget {
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (_, index) => ListTile(
                            onTap: () {
                              Get.back();
                              _updateDesignController.selectedSubCategoryId = -1;
                              _updateDesignController.subCategoryController.text = '';
                              _commonController.subCategoryList.value = [];
                              categoryController.text =
                                  _commonController.categoryList[index].name;
                              _updateDesignController.selectedCategoryId =
                            ...
                            trailing: _updateDesignController.selectedCategoryId ==
                                    _commonController.categoryList[index].id
                                ? Icon(
                                    Icons.check_circle,
                                    color: Get.theme.primaryColor,
